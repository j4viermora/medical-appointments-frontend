...
import { IDoctorResponse, IListPatientsResponse, ILoginResponse } from 'interfaces';
import { Appointment, IEventsResponse } from 'interfaces/events.interfaces';
import {
	IPatienDataRegister,
	IPatientUpdate,
...
export const registerAppointment = async (body: Appointment) => {
